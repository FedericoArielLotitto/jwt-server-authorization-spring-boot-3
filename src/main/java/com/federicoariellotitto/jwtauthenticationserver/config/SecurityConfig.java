...
import com.federicoariellotitto.jwtauthenticationserver.filters.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private final JwtAuthenticationFilter jwtAuhenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.POST, "/api/v1/signup", "/api/v1/singin").permitAll()
